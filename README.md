...
Verkefnið felst í því að smíða vef eftir forskrift frá kennara. Efnið eru fyrirlestrarnir hans Óla og við setjum það upp á þæginlegt form með html, css og javascript.
Við erum þrjú saman sem vinnum þetta verkefni.
Við heitum:
Kumasi Máni Hodge Carr (kmh13@hi.is), 
Valourie Ásgeirsdóttir (vav18@hi.is) og 
Þóra Kristín Klemenzdóttir (tkk8@hi.is).

Við skiptum verkefninu á milli okkar en við unnum þó eins mikið saman og við gátum og gekk fínt að finna tíma fyrir það.


## Keyrsla á verkefni

Við ákváðum að nota github og heimasvæðið hennar Valourie svo hér eru linkar á það:

https://notendur.hi.is/vav18/vefforritun/

VANTAR GITHUB LINKINN


## Uppsetning verkefnis

Uppsetningin er í grunninn alveg eins og hjá Óla en við bættum smá við:

src mappa: bættum inn í hana fyrirlestur.js og síðan inn í src er mappa sem heitir lib og inn í hana settum við takkar.js og síðan er líka mappa þar inni sem heitir styles og við bættum inn í hana fyrirlestur.scss
